...
def setShortcuts():
	...
	if(addhotkeys):
		...
		if dename == "gnome":
			...
			cmdline("gsettings set org.gnome.desktop.wm.keybindings minimize \"['<Alt>F9']\"")
		...
		# 	print("Apply budgie shortcuts here")
			...
			cmdline('kwriteconfig5 --file "$HOME/.config/kglobalshortcutsrc" --group "kwin" --key "Minimize Window" "Meta+PgDown,Minimize Window"')
